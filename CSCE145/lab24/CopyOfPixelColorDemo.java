...
public class CopyOfPixelColorDemo {
  public static void main(String[] args) {
    ...
    for (int i = 0; i<300; i++)
    {
    	...
    	for (int j = 0; j<450; j++)
    	{
    		...
    		red = ((pixelColor.getRed()+pixelColor.getGreen()+pixelColor.getBlue())/3);
    		green = ((pixelColor.getRed()+pixelColor.getGreen()+pixelColor.getBlue())/3);
    		blue = ((pixelColor.getRed()+pixelColor.getGreen()+pixelColor.getBlue())/3);
    		Color newpixelColor = new Color(red,green,blue);
    		
    		
    		pict.setRGB(x, y, newpixelColor.getRGB());
