...
// This file should NOT be changed.  If you see an error in this file, you need to alter one of
// your other Java classes
...
// Second set of tests
		...
		player1.setName("Connor Shaw");
		if((player1.getName()).equals("Connor Shaw"))
			System.out.println("Passed");
		else
			System.out.println("Failed");
			
		System.out.print("Changing name of player2...");
		player2.setName("Marcus Lattimore");
		if((player2.getName()).equals("Marcus Lattimore"))
			System.out.println("Passed");
		else
			System.out.println("Failed");
			
		System.out.print("Changing name of player3...");
		player3.setName("Melvin Ingram");
		if((player3.getName()).equals("Melvin Ingram"))
			System.out.println("Passed");
		else
			System.out.println("Failed");
			
		System.out.print("Changing name of player4...");
		player4.setName("Garcia");
		if((player4.getName()).equals("Garcia"))
			System.out.println("Passed");
		else
			System.out.println("Failed");
